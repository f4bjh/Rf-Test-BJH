...
HD_PWD='/home/f4bjh/devel/Rf-Test-BJH/hw/freq_front_end/reciproq_freq_meas/reciproq_freq_meas.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_reciproc_freq_meas.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_reciproc_freq_meas.tcl -notrace
