...
HD_PWD='/home/f4bjh/devel/Rf-Test-BJH/hw/freq_front_end/reciproq_freq_meas/reciproq_freq_meas.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_reciproc_freq_meas.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_reciproc_freq_meas.tcl
