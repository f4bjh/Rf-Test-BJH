...
#
# Script generated by Vivado on Wed Sep 10 22:55:40 CEST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tb_design_1.sh
...
#
# Usage        : tb_design_1.sh
#                tb_design_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_design_1.sh [-reset_run]
#                tb_design_1.sh [-reset_log]
#                tb_design_1.sh [-help]
#
...
export RDI_DATADIR="/home/f4bjh/Xilinx/Vivado/2024.2/data"

# set xvlog options
xvlog_opts="--incr --relax "

# script info
echo -e "tb_design_1.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_design_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot tb_design_1 xil_defaultlib.tb_design_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tb_design_1 -key {Behavioral:sim_1:Functional:tb_design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/tb_design_1.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/f4bjh/Xilinx/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tb_design_1.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_design_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_design_1.sh [-help]\n\
Usage: tb_design_1.sh [-step]\n\
Usage: tb_design_1.sh [-lib_map_path]\n\
Usage: tb_design_1.sh [-reset_run]\n\
Usage: tb_design_1.sh [-reset_log]\n\
Usage: tb_design_1.sh [-keep_index]\n\
Usage: tb_design_1.sh [-noclean_files]\n\n\
