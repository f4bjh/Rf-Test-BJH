...
#                script (type 'tb_design_1.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.tb_design_1 xil_defaultlib.glbl -o tb_design_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./tb_design_1_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/f4bjh/devel/Rf-Test-BJH/tests/hf_gen_fpga/Cmod_A7-hf_gen_fpga/Cmod_A7-hf_gen_fpga.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key tb_design_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc tb_design_1_simv.daidir vcs_lib c.obj)
