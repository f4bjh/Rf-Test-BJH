...
HD_PWD='/home/f4bjh/devel/Rf-Test-BJH/tests/hf_gen_fpga/Cmod_A7-hf_gen_fpga/Cmod_A7-hf_gen_fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hf_gen_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hf_gen_fpga.tcl -notrace
