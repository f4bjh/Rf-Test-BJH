...
HD_PWD='/home/f4bjh/devel/Rf-Test-BJH/tests/hf_gen_fpga/Cmod_A7-hf_gen_fpga/Cmod_A7-hf_gen_fpga.runs/tb_design_1_Stimu_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_design_1_Stimu_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_design_1_Stimu_0_0.tcl
